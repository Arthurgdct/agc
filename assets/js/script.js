...
document.getElementById('veryShort').addEventListener('click', () => {
    modifyDesc('Bonjour, je m\'appelle Arthur. J\'ai 27 ans et je suis passionné d\'informatique. Je suis à la recherche d\'une alternance pour faire un CDA (Concepteur Développeur d\'Application). Je suis déterminé & j\'ai une bonne expérience de la vie en entreprise.')
})
document.getElementById('short').addEventListener('click', () => {
    modifyDesc('Bonjour, je m\'appelle Arthur. J\'ai 27 ans et je suis passionné d\'informatique depuis petit. Je suis à la recherche d\'une alternance pour faire un CDA (Concepteur Développeur d\'Application) afin de continuer ma reconversion et vivre d\'un emploi dans un domaine qui me passionne véritablement. Je suis déterminé & j\'ai une bonne expérience de la vie en entreprise.')
})
document.getElementById('classic').addEventListener('click', () => {
    modifyDesc('Bonjour, je m\'appelle Arthur. J\'ai 27 ans et je suis passionné d\'informatique depuis petit. Dans la vie j\'ai d\'abord fait des études de menuisierie, puis j\'ai travaillé quelques années à l\'usine, que j\'ai finalement laissée derrière moi pour tenter ma chance et devenir développeur, d\'en faire mon métier, avec une formation. Ce qui nous emmène à ce jour, où je suis à la recherche d\'une alternance pour faire un CDA (Concepteur Développeur d\'Application) afin de continuer ma reconversion et vivre d\'un emploi dans un domaine qui me passionne véritablement. Je suis quelqu\'un de déterminé qui a une bonne expérience de la vie en entreprise et qui a énormément envie d\'en apprendre plus chaque jour.')
})
document.getElementById('long').addEventListener('click', () => {
    modifyDesc('Bonjour, je m\'appelle Arthur. J\'ai 27 ans et je suis passionné d\'informatique depuis petit, où j\'ai découvert les ordinateurs grâce à mon frère et les Lan de "Age Of Empire" dans notre garage. Il n\'aura fallu que quelques années avant que je commence à "bidouiller" mes premiers serveurs Minecraft, puis bien d\'autres aventures informatiques ont suivi... Mais dans la vie, j\'ai d\'abord fait des études de menuiserie, puis j\'ai travaillé quelques années à l\'usine, que j\'ai finalement laissée derrière moi pour tenter ma chance et devenir développeur, d\'en faire mon métier, avec une formation. Ce qui nous emmène à ce jour, où je suis à la recherche d\'une alternance pour faire un CDA (Concepteur Développeur d\'Application)afin de continuer ma reconversion et vivre d\'un emploi dans un domaine qui me passionne véritablement. Toute cette petite histoire pour dire que je suis quelqu\'un de déterminé qui a une bonne expérience de la vie en entreprise et qui a énormément envie d\'en apprendre plus chaque jour.')
})
/*caroussel*/
